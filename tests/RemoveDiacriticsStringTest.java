...
/**
 * Class to test the method `removeDiacritics` of a `ParsingDiacriticsWorker`.
 */
public class RemoveDiacriticsStringTest {
    ...
    void testNoRemoveLetters() {
        ParsingDiacriticsWorker w = new ParsingDiacriticsWorker();
        String input;
        String output;

        //One letter
        input = "a";
        output = w.removeDiacritics_Testing(input);
